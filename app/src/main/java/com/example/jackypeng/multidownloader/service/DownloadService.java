package com.example.jackypeng.multidownloader.service;
...
import com.example.jackypeng.multidownloader.manager.DownloadConfig;
import com.example.jackypeng.multidownloader.manager.DownloadManager;
...
public class DownloadService extends Service {
    ...
    public void onDestroy() {
         ...
         * 关闭下载池中的所有正在下载的任务
         */
        downloadManager.pauseAllDownloadTasks();
    }
}
